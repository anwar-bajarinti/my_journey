...
int main(void)
{
    ...
    GpioLed.GPIO_Pin_Config.GPIO_PinMode = GPIO_MODE_OUT;     // Output mode
    ...
    GpioBtn.GPIO_Pin_Config.GPIO_PinMode = GPIO_MODE_IN;      // Input mode
    ...
    while (1)
    {
        ...
        {        	printf(" inside if \n");
            ...
            GPIO_WriteToOutputPin(GPIOA, GPIO_PIN_NO_3,1); // Toggle LED
