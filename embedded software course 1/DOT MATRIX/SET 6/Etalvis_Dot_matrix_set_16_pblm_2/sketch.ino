...
void loop() {
  ...
  for (char j = 0; j < 8; j++) {
  max7219_send_all(j + 1,  digit1[8-j],digit2[8-j],digit3[8-j], 0x00 );
}
for(volatile long long i=0;i<100000;i++);
 for (char j = 0; j < 8; j++) {
  max7219_send_all(j + 1, digit1[8-j],digit2[8-j], 0x00, 0x00 );
}
for(volatile long long i=0;i<100000;i++);
for (char j = 0; j < 8; j++) {
  max7219_send_all(j + 1,  digit1[8-j],0x00,0x00, 0x00);
}
for(volatile long long i=0;i<100000;i++);
for (char j = 0; j < 8; j++) {
