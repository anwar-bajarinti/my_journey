...
void loop() {
  for (int shift = 16; shift >=8; shift--) {
  ...
  for (char j = 0; j < 8; j++) {
  max7219_send_all(j + 1,  0x00,digit2[8-j],digit3[8-j], digit4[8-j] );
}
for(volatile long long i=0;i<100000;i++);
 for (char j = 0; j < 8; j++) {
  max7219_send_all(j + 1,  0x00, 0x00,digit3[8-j],digit4[8-j] );
}
for(volatile long long i=0;i<100000;i++);
for (char j = 0; j < 8; j++) {
  max7219_send_all(j + 1,  0x00,0x00, 0x00,digit4[8-j]);
}
for(volatile long long i=0;i<100000;i++);
for (char j = 0; j < 8; j++) {
  max7219_send_all(j + 1, 0x00,0x00,0x00, 0x00);
}
