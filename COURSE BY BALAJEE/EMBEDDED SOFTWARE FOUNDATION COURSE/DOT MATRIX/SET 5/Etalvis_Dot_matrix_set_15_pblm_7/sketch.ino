...
void setup() {
  ...
  // for(volatile long long  i=0;i<1000000;i++);
   ...
   for (int row = 0; row < 8; row++) {
    ...
    max7219_send_all(row + 1,  0x00, 0x00, 0x00,digit1[row]);
  }
  for(volatile long long  i=0;i<100000;i++);
  for (int row = 0; row < 8; row++) {
    
    max7219_send_all(row + 1,  0x00, 0x00,digit1[row],digit2[row]);
  }
  for(volatile long long  i=0;i<100000;i++);
  for (int row = 0; row < 8; row++) {
    
    max7219_send_all(row + 1,  0x00, digit1[row],digit2[row],digit3[row]);
  }
  for(volatile long long  i=0;i<100000;i++);
  for (int row = 0; row < 8; row++) {
