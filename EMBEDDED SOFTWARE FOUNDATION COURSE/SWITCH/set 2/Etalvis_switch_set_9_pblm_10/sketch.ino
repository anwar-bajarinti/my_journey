...
void loop() {
  ...
  if (sw0_pressed  && sw4_pressed && sw7_pressed && sw6_pressed ) {
    *port_a = 0x00;  // Light OFF (PA5)
    sw0_pressed = 0; // Reset flags
    sw4_pressed = 0;
    sw7_pressed = 0;
    sw6_pressed = 0;
  }
