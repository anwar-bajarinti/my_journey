...
//   }
  ...
  for (char j = 0; j < 8; j++) {
  max7219_send_all(j + 1,  digit2[j],0x00,0x00,digit3[j] );
}
for(volatile long long i=0;i<100000;i++);
 for (char j = 0; j < 8; j++) {
  max7219_send_all(j + 1, digit1[j],digit2[j] ,digit3[j], digit4[j]);
}
// for(volatile long long i=0;i<100000;i++);
// for (char j = 0; j < 8; j++) {
//   max7219_send_all(j + 1,  digit2[8-j],digit3[8-j],digit4[8-j], 0x00);
// }
// for(volatile long long i=0;i<100000;i++);
// for (char j = 0; j < 8; j++) {
//   max7219_send_all(j + 1,digit1[8-j],digit2[8-j],digit3[8-j],digit4[8-j] );
// }
//for(volatile long long i=0;i<100000;i++);
